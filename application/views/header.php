...
<script type="text/javascript" src="<?=URL::base(true)?>/application/js/plugins/charts/jquery.flot.js"></script>
<script type="text/javascript" src="<?=URL::base(true)?>/application/js/plugins/charts/jquery.flot.orderBars.js"></script>
<script type="text/javascript" src="<?=URL::base(true)?>/application/js/plugins/charts/jquery.flot.pie.js"></script>
<script type="text/javascript" src="<?=URL::base(true)?>/application/js/plugins/charts/jquery.flot.resize.js"></script>
...
<script type="text/javascript" src="<?=URL::base(true)?>/application/js/charts/chart.js"></script>
...
<div id="leftSide">
    <div class="logo">
    	<a href="index.html">
    		<?=HTML::image('application/images/logo.png', array('alt'=>'logo SGD', 'title'=>'Sistema Gerencial Delivery'))?>
    	</a>
	</div>
    ...
    <ul id="menu" class="nav">
        <li class="dash"><a href="<?=URL::base(true)?>index.php/home" title="" class="active"><span>Dashboard</span></a></li>
        <li class="ui"><a href="#" title="" class="exp"><span>Clientes</span><strong>2</strong></a>
            <ul class="sub">
                <li><a href="<?=URL::base()?>index.php/cliente" title="">Ver/Editar Clientes</a></li>
                <li><a href="<?=URL::base()?>index.php/cliente/cadastro" title="">Add novo Cliente</a></li>
            </ul>
        </li>
        <li class="ui"><a href="#" title="" class="exp"><span>Produtos</span><strong>2</strong></a>
            <ul class="sub">
                <li><a href="<?=URL::base()?>index.php/produto" title="">Ver/Editar Produtos</a></li>
                <li><a href="<?=URL::base()?>index.php/produto/produto" title="">Add novo Produto</a></li>
            </ul>
        </li>
        <li class="charts"><a href="charts.html" title=""><span>Statistics and charts</span></a></li>
        <li class="forms"><a href="ui_elements.html" title=""><span>Interface elements</span></a></li>
...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            <div class="welcome">
            	<a href="#" title="">
            		<?=HTML::image('application/images/userPic.png', array('alt' => ''))?>
            	</a>
            	<span>Administrador, Bem Vindo !</span>
            </div>
            <div class="userNav">
                <ul>
                    <li><a href="#" title=""><img src="<?=URL::base(true)?>/application/images/icons/topnav/profile.png" alt="" /><span>Perfil</span></a></li>
                    <li><a href="#" title=""><img src="<?=URL::base(true)?>/application/images/icons/topnav/tasks.png" alt="" /><span>Tasks</span></a></li>
                    <li class="dd"><a title=""><img src="<?=URL::base(true)?>/application/images/icons/topnav/messages.png" alt="" /><span>Menssagens</span><span class="numberTop">8</span></a>
                        <ul class="userDropdown">
                            <li><a href="#" title="" class="sAdd">Nova menssagem</a></li>
                            <li><a href="#" title="" class="sInbox">Entrada</a></li>
                            <li><a href="#" title="" class="sOutbox">Enviados</a></li>
                            <li><a href="#" title="" class="sTrash">Lixo</a></li>
                        </ul>
                    </li>
                    <li><a href="#" title=""><img src="<?=URL::base(true)?>/application/images/icons/topnav/settings.png" alt="" /><span>Settings</span></a></li>
                    <li><a href="login.html" title=""><img src="<?=URL::base(true)?>/application/images/icons/topnav/logout.png" alt="" /><span>Logout</span></a></li>
                </ul>
            </div>
            <div class="clear"></div>
        </div>
    ...
    <div class="resp">
        <div class="respHead">
            <a href="index.html" title=""><img src="<?=URL::base(true)?>/application/images/loginLogo.png" alt="" /></a>
        </div>
        
        <div class="cLine"></div>
        <div class="smalldd">
            <span class="goTo"><img src="<?=URL::base(true)?>/application/images/icons/light/home.png" alt="" />Dashboard</span>
            <ul class="smallDropdown">
                <li><a href="index.html" title=""><img src="<?=URL::base(true)?>/application/images/icons/light/home.png" alt="" />Painel SGD</a></li>
                <li><a href="charts.html" title=""><img src="<?=URL::base(true)?>/application/images/icons/light/stats.png" alt="" />Clientes</a></li>
                <li><a href="#" title="" class="exp"><img src="<?=URL::base(true)?>/application/images/icons/light/pencil.png" alt="" />Clientes<strong>4</strong></a>
                    <ul>
                        <li><a href="forms.html" title="">Ver/editar cliente</a></li>
                        <li><a href="form_validation.html" title="">Add novo cliente</a></li>
                    </ul>
                </li>
                <li><a href="ui_elements.html" title=""><img src="<?=URL::base(true)?>/application/images/icons/light/users.png" alt="" />Interface elements</a></li>
                <li><a href="tables.html" title="" class="exp"><img src="<?=URL::base(true)?>/application/images/icons/light/frames.png" alt="" />Tables<strong>3</strong></a>
                    <ul>
                        <li><a href="table_static.html" title="">Static tables</a></li>
                        <li><a href="table_dynamic.html" title="">Dynamic table</a></li>
                        <li class="last"><a href="table_sortable_resizable.html" title="">Sortable &amp; resizable tables</a></li>
                ...
                <li><a href="#" title="" class="exp"><img src="<?=URL::base(true)?>/application/images/icons/light/fullscreen.png" alt="" />Widgets and grid<strong>2</strong></a>
                    <ul>
                        <li><a href="widgets.html" title="">Widgets</a></li>
                        <li class="last"><a href="grid.html" title="">Grid</a></li>
                    </ul>
                </li>
                <li><a href="#" title="" class="exp"><img src="<?=URL::base(true)?>/application/images/icons/light/alert.png" alt="" />Error pages<strong>6</strong></a>
                    <ul class="sub">
                        <li><a href="403.html" title="">403 page</a></li>
                        <li><a href="404.html" title="">404 page</a></li>
                        <li><a href="405.html" title="">405 page</a></li>
                ...
                <li><a href="file_manager.html" title=""><img src="<?=URL::base(true)?>/application/images/icons/light/files.png" alt="" />File manager</a></li>
                <li><a href="#" title="" class="exp"><img src="<?=URL::base(true)?>/application/images/icons/light/create.png" alt="" />Other pages<strong>3</strong></a>
                    <ul>
                        <li><a href="typography.html" title="">Typography</a></li>
                        <li><a href="calendar.html" title="">Calendar</a></li>
                        <li class="last"><a href="gallery.html" title="">Gallery</a></li>
    ...
    <div class="titleArea">
        <div class="wrapper">
            <div class="pageTitle">
                <h5>Dashboard</h5>
                <span>Se você tiver dúvidas de como usar o sistema, poderá ligar diramente para +55 51 3372.0032</span>
            </div>
            <div class="middleNav">
                <ul>
